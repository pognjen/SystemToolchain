...
public:
    ...
    {
        std::cout << "Error: symbol " << symbol << " does not start with letter on line "
                  << line_number << "\n";
        exit(-1);
    }
    static void symbol_not_in_section(std::string symbol, int line_number)
    {
        std::cout << "Error: symbol"
                  << " is not defined in section on line " << line_number << "\n";
        exit(-1);
    }
    ...
    {
        std::cout << "Error: symbol " << symbol << " declared .extern and defined locally on line "
                  << line_number << "\n";
        exit(-1);
    }
    ...
    {
        std::cout << "Error: directive " << directive << " is not defined in section on line "
                  << line_number << "\n";
        exit(-1);
    }
    static void directive_requires_one_operand(std::string directive, int line_number)
    {
        std::cout << "Error: directive " << directive << " requires at least one operand on line "
                  << line_number << "\n";
        exit(-1);
    }
    ...
    {
        std::cout << "Error: directive " << directive << " requires two operands on line "
                  << line_number << "\n";
        exit(-1);
    }
    static void wrong_number_of_operands(std::string instruction, int line_number)
    {
        std::cout << "Error: instruction " << instruction
                  << " has wrong number of operands on line " << line_number << "\n";
        exit(-1);
    }
    ...
    {
        std::cout << "Error: there can not be immediate value as destination operand on line "
                  << line_number << "\n";
        exit(-1);
    }
    ...
    {
        std::cout << "Error: instruction " << instr << " requires " << num_operands << " on line "
                  << line_number << '\n';
        exit(-1);
    }
